...
public class SwaggerConfig {
    ...
    public static String DEVELOPER = "Amit Ghosh";
    public static String DEVELOPER_EMAIL = "amitghosh@gmail.com";
    public static String DEVELOPER_WEBSITE = "https://amitghosh.github.io";
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("io.github.amitghosh.api"))
